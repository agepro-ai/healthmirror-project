      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-8">
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-xl font-bold mb-4">HealthMirror</h3>
            <p className="text-gray-600 mb-4">Your complete health picture in one place.</p>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} HealthMirror. All rights reserved.
          </p>
          <p className="flex items-center text-gray-400 text-sm mt-4 md:mt-0">
            Made with <Heart className="h-4 w-4 text-red-500 mx-1" /> for a healthier world
          </p>
        </div>
      </div>
    </footer>
